-- Hurtado Trader Academy — esquema de Supabase
...
-- ---------------------------------------------------------------------------
-- Datos de demostración (8 clases). Cámbialos o bórralos cuando quieras.
-- ---------------------------------------------------------------------------
insert into public.classes
  (id, title, description, category, level, video_url, embed_url, thumbnail, duration_min, instructor, tags, created_at)
values
